...
#else
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null,Type  TTType=null
#endif
)
        {
            var data = QueryInternal<T>(cnn, sql, param as object, transaction, commandTimeout, commandType,TType:TTType);
...
this IDbConnection cnn, string sql, dynamic param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        /// </summary>
        private static IEnumerable<T> QueryInternal<T>(this IDbConnection cnn, string sql, object param, IDbTransaction transaction, int? commandTimeout, CommandType? commandType,Type TType=null)
        {
            var identity = new Identity(sql, commandType, cnn,  (TType==null ? typeof(T) : TType), param == null ? null : param.GetType(), null);
            ...
            try
            {
                ...
                {
                    tuple = info.Deserializer = new DeserializerState(hash, GetDeserializer(TType==null ? typeof(T) : TType, reader, 0, -1, false));
