<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="CarouselManager.aspx.cs" Inherits="Mars.Server.WebApp.Article.ArticleCarouselManager" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="navigation" runat="server">
    <li class="active">发现轮播维护</li>
</asp:Content>

<asp:Content ID="Content4" ContentPlaceHolderID="pageheader" runat="server">
    <h1>发现轮播维护<small><i class="icon-double-angle-right"></i>发现轮播管理</small></h1>
</asp:Content>
...
<asp:Content ID="Content5" ContentPlaceHolderID="content" runat="server">
    ...
    <OpenBook:TemplateWrapper ID="tmpAdvertList" runat="server" TemplateSrc="~/Templates/CarouselTemplate.ascx"
    ...
    <script type="text/javascript">
        ...
        var canceladvert = function (pid) {
            bootbox.confirm("您确认要取消该文章首页轮播?", function (result) {
                if (result) {
                    $.post(_root + "handlers/ArticleController/CancelCarousel.ashx", { "pid": pid, "ts": new Date().getTime() }, function (data) {
                        var json = eval("(" + data + ")");

                        if (json.status == "1") {
                            bootbox.dialog("取消发现轮播成功!", [{
                                "label": "OK",
