<%@ Page Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="SetAdvertState.aspx.cs" Inherits="Mars.Server.WebApp.Article.SetAdvertState" %>
            ...
            <div class="row-fluid">
                <form runat="server" class="form-horizontal" id="validationf">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="chkAdvert">是否首页轮播:</label>
                        <div class="controls">
                            <div class="span3">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="span12">
                                <input type="text" id="txtAdvertOrder" name="txtAdvertOrder" runat="server" />
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        var save = function () {
            if (!$("#validationf").valid()) {
                ...
                var data = { "pid": pid, "status": chkAdvert, "order": txtAdvertOrder, "adsendtime": $("#content_txtAdsEndTime").val(), "ts": new Date().getTime() };
                $.post(_root + "handlers/ArticleController/ChangeAdvertState.ashx", data, function (data) {
                    var json = eval("(" + data + ")");
