    ...
    <table class="table table-striped table-bordered table-hover" id="table_bug_report">
        <thead>
            <tr>
                ...
                <OpenBook:Th runat="server" ID="thAdvert" CssClass="center" Text="首页轮播" BindingFiled="Advert" OutPutOrder="6" />
        ...
        <tbody>
            ...
            <tr id="tr{$T.row.EventItemID}">
                ...
                <td class="center">{#if $T.row.DiscoverAdvert == 0}
                        <span class="badge badge-warning">否</span>
                    {#else}
                    <span class="badge badge-success">是</span>
                    {#/if}
                </td>
                <td class="center">{#if $T.row.Advert == 0}
                        <span class="badge badge-warning">否</span>
                    {#else}
                    <span class="badge badge-success">是</span>
                    {#/if}
