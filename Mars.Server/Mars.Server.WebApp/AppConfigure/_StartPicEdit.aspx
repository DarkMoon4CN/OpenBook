...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <div class="alert alert-block alert-success form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label" for="content_txt_url">访问URL:</label>
            <div class="controls">
                <input class="span10" type="text" name="txt_url" id="txt_url" placeholder="访问URL" runat="server" />
            </div>
        </div>
        ...
        var addstartpic = function () {
            if (checkForm()){
                var pms = {
                    ...
                    "url": $("#content_txt_url").val(),
                    "defalut": true,//$("#content_chk_isdefault").get(0).checked,
                    "ts": new Date().getTime()
                };
