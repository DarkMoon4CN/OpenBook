...
$(function () {
    ...
    $.get("/handlers/LogController/CountNewsPageView.ashx", { "chn": $.getUrlParam('chn'), "share": $.getUrlParam('s'), "browse": $.getUrlParam('b'), "token": $.getUrlParam('m'), "sharetype": $.getUrlParam('st'), "e": e, "w": $.getUrlParam('w'), "ts": new Date().getTime() }, function (data) { return true; });
});
