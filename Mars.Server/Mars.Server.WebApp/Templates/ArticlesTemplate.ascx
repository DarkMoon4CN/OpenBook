                ...
                <td class="center">
                    <div class="inline position-relative">
                        ...
                        <ul class="dropdown-menu dropdown-icon-only dropdown-light pull-right dropdown-caret dropdown-close">
                            <li><a title="" target="_blank" class="tooltip-success" href="ArticleEdit2.aspx?fun={$T.fun}&pid={$T.row.EventItemID}" data-original-title="Edit" data-placement="left" data-rel="tooltip"><span class="green">编辑</span></a></li>
