<%@ Page Title="" Language="C#" MasterPageFile="~/Common.Master" AutoEventWireup="true" CodeBehind="_ExhibitorImport.aspx.cs" Inherits="Mars.Server.WebApp.Exhibition._ExhibitorImport" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="content" runat="server">
    <form id="frmImport" runat="server">
     <div class="alert alert-block alert-success form-horizontal">
        ...
        <div class="control-group">
            <label class="control-label" for="content_file_exhibitor">展商Excel:</label>
            <div class="controls">
                <asp:FileUpload runat="server" ID="file_exhibitor" />
            </div>
        </div>
        <div class="control-group">
...
<asp:Content ID="Content4" ContentPlaceHolderID="inlinescripts" runat="server">
    <script type="text/javascript">
        ...
        var checkForm = function () {
            ...
            if ($.trim($("#content_file_exhibitor").val()) == "") {
                error += "请选择上传的Excel\n\r";
            }
