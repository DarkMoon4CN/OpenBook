<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="_ExhibitionList.aspx.cs" Inherits="Mars.Server.WebApp.Exhibition._ExhibitionList" %>
...
<asp:Content ID="Content6" ContentPlaceHolderID="inlinescripts" runat="server">
    <script type="text/javascript">
        ...
        var addExhibition = function () {
            asyncbox.open({
                modal: true,
                id: "exhibition",
                title: "添加展场信息",
                url: _root + "Exhibition/_ExhibitionEdit.aspx",
                width: 950,
                height: 750
            });
        }

        var modExhibition = function (id) {
            asyncbox.open({
                modal: true,
                id: "exhibition",
                title: "编辑展场信息",
                url: _root + "Exhibition/_ExhibitionEdit.aspx?id=" + id,
                width: 950,
                height: 550
            });
        }
