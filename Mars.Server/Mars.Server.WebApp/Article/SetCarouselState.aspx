        ...
        <div class="widget-main">
            <div class="row-fluid">
                <form runat="server" class="form-horizontal" id="validationf">
                    ...
                    <div class="control-group">
                        <label class="control-label" for="content_txtAdvertOrder">轮播顺序:</label>
                        <div class="controls">
                            <div class="span12">
    ...
    <script type="text/javascript">  
        ...
        var save = function () {
            if (!$("#validationf").valid()) {
                ...
                var data = { "pid": pid, "status": chkAdvert, "adsendtime": $("#content_txtAdsEndTime").val(), "order": txtAdvertOrder, "ts": new Date().getTime() };
