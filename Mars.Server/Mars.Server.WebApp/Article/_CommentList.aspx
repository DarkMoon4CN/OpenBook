<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="_CommentList.aspx.cs" Inherits="Mars.Server.WebApp.Article._CommentList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="pageheader" runat="server">
    <h1>信息发布管理<small><i class="icon-double-angle-right"></i>文章评论</small></h1>
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="content" runat="server">
    ...
    <OpenBook:TemplateWrapper ID="tmpCommentList" runat="server" TemplateSrc="~/Templates/CommentListTemplate.ascx"
...
<asp:Content ID="Content6" ContentPlaceHolderID="inlinescripts" runat="server">
    <script type="text/javascript">
        var changeViewState = function (obj) {
            $.post(_root + "handlers/CommentController/ChangeViewState.ashx", { "_id": $(obj).attr("cid"), "_vs": $(obj).val(), "ts": new Date().getTime() }, function (data) {
                var json = eval("(" + data + ")");
                if (json.state != "1") {
