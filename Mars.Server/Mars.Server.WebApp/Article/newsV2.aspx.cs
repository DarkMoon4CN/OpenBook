...
{
    public partial class newsV2 : WxBasePage
    {
        public string moblieShareHeader = string.Empty;
        public string moblieShareFooter = string.Empty;
        public string prefix = string.Empty;
        protected string isShatre = "0";
        protected void Page_Load(object sender, EventArgs e)
        {
            //if (string.IsNullOrEmpty(Request["v"]))
            //{
            //    //string rurl = WebMaster.Domain + "_news/" + Request["pid"] + ".html";
            //    string rurl = WebMaster.Domain + "Article/news.aspx?pid=" + Request["pid"] + "";
