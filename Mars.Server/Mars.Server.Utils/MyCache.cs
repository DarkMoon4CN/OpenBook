...
namespace Mars.Server.Utils
{
    public class MyCache<T>
    {
        ...
        /// 日缓存因子
        /// </summary>
        public static readonly int DayFactor = 17280 * 7;
        /// <summary>
        /// 小时缓存因子
        /// </summary>
        ...
        public static void Insert(string key, T obj, CacheDependency dep)
        {
        ...
        public static void Insert(string key, T obj, int seconds)
        {
        ...
        public static void Insert(string key, T obj, int seconds, CacheItemPriority priority)
        {
        ...
        /// <param name="seconds">缓存秒数</param>
        public static void Insert(string key, T obj, CacheDependency dep, int seconds)
        {
        ...
        /// <param name="seconds">缓存秒数</param>
        /// <param name="priority">缓存优先级</param>
        public static void Insert(string key, T obj, CacheDependency dep, int seconds, CacheItemPriority priority)
        {
            if (obj != null)
            {
        ...
        public static void MicroInsert(string key, T obj, int secondFactor)
        {
            if (obj != null)
            {
        ...
        public static void Max(string key, T obj)
        {
            Max(key, obj, null);
        }
        /// <summary>
        ...
        /// <param name="obj">缓存对象</param>
        /// <param name="dep">缓存依赖项</param>
        public static void Max(string key, T obj, CacheDependency dep)
        {
            if (obj != null)
            {
