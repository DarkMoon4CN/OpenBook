...
namespace Log4Simple.Util
{
    ...
    public class CyclicBuffer
    {
        ...
        public CyclicBuffer(int maxSize)
        {
            ...
            m_maxSize = maxSize;
            m_events = new LoggingData[maxSize];
            m_first = 0;
            m_last = 0;
            m_numElems = 0;
        }
        ...
        /// </para>
        /// </remarks>
        public LoggingData Append(LoggingData loggingEvent)
        {
            ...
            lock (this)
            {
                ...
                LoggingData discardedLoggingEvent = m_events[m_last];
        ...
        /// </para>
        /// </remarks>
        public LoggingData PopOldest()
        {
            lock (this)
            {
                LoggingData ret = null;
                if (m_numElems > 0)
                {
                    m_numElems--;
        ...
        /// </para>
        /// </remarks>
        public LoggingData[] PopAll()
        {
            lock (this)
            {
                LoggingData[] ret = new LoggingData[m_numElems];
