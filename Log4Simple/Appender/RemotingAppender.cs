...
namespace Log4Simple.Appender
{
    ...
    public class RemotingAppender : BufferingAppenderSkeleton
    {
        ...
        override protected void SendBuffer(LoggingData[] events)
        {
        ...
        /// This method expects to be passed an array of <see cref="LoggingData"/>
        ...
        private void SendBufferCallback(object state)
        {
            try
            {
                LoggingData[] events = (LoggingData[])state;
        ...
        /// <summary>
        /// Interface used to deliver <see cref="LoggingData"/> objects to a remote sink.
        /// </summary>
        /// <remarks>
        ...
        public interface IRemoteLoggingSink
        {
            ...
            /// </para>
            /// </remarks>
            void LogEvents(LoggingData[] events);
        }
    }
}
