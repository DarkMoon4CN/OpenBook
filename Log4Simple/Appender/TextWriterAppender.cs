...
namespace Log4Simple.Appender
{
    ...
    public class TextWriterAppender : AppenderSkeleton
    {
        ...
        /// </para>
        /// </remarks>
        override protected void Append(LoggingData[] loggingEvents)
        {
        ...
        virtual protected void WriteFooter()
        {
            if (Layout != null && m_qtw != null && !m_qtw.Closed)
            {
                ...
                if (f != null)
                {
                    m_qtw.Write(SystemInfo.GetDT_FullMiSecondString(DateTime.Now) + " " + f);
                }
            }
        }
        ...
        virtual protected void WriteHeader()
        {
            if (Layout != null && m_qtw != null && !m_qtw.Closed)
            {
                ...
                if (h != null)
                {
                    m_qtw.Write(SystemInfo.GetDT_FullMiSecondString(DateTime.Now) + " " + h);
                }
            }
        }
