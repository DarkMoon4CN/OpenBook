...
using IRemoteLoggingSink = Log4Simple.Appender.RemotingAppender.IRemoteLoggingSink;
...
namespace Log4Simple.Plugin
{
    ...
    public class RemoteLoggingServerPlugin : PluginSkeleton
    {
        ...
        /// <summary>
        /// Delivers <see cref="LoggingData"/> objects to a remote sink.
        /// </summary>
        /// <remarks>
        /// <para>
        ...
        private class RemoteLoggingSinkImpl : MarshalByRefObject, IRemoteLoggingSink
        {
            ...
            /// </para>
            /// </remarks>
            public void LogEvents(LoggingData[] events)
            {
                if (events != null)
                {
                    foreach (LoggingData logEvent in events)
                    {
                        if (logEvent != null)
                        {
